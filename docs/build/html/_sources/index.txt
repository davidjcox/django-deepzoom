...
* saves XML needed by deep zoom viewer
...
Change <VERSION> to one of the available version numbers, of course.  Installing to a 
...
The save() method of the overridden class can be overridden, of course, to add additional fields or 
features.
